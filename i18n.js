...
(function (global) {
    const DICTS = {
        'zh-TW': {
            ...
            pay_per_image: '/ 張',
            pay_per_2_images: '/ 2 張',
            pay_per_4_images: '/ 4 張',
            pay_per_year: '/ 年',
            pay_notice: '虛擬商品，購買後不支持退款',
            pay_notice_year: '包年方案將於購買後自動生效，可解鎖全站付費功能',
            pay_confirm: '確認支付',
            pay_tier_title: '更划算的選擇',
            pay_tier_1_qty: '1 張',
            pay_tier_2_qty: '2 張',
            pay_tier_4_qty: '4 張',
            pay_tier_year_qty: '包年無限下載',
            pay_add_cart: '加入購物車',
            pay_added_cart: '已加入 ✓',
            cart_title: '下載列表',
            cart_select_all: '全選',
            cart_clear: '清空列表',
            cart_empty: '下載列表目前是空的',
            cart_total_label: '結算金額',
            cart_checkout: '結算',
            bazi_board_title: '八字排盤',
            pillar_year: '年柱',
            pillar_month: '月柱',
            pillar_day: '日柱',
            pillar_hour: '時柱',
        ...
        'zh-CN': {
            ...
            pay_per_image: '/ 张',
            pay_per_2_images: '/ 2 张',
            pay_per_4_images: '/ 4 张',
            pay_per_year: '/ 年',
            pay_notice: '虚拟商品，购买后不支持退款',
            pay_notice_year: '包年方案将于购买后自动生效，可解锁全站付费功能',
            pay_confirm: '确认支付',
            pay_tier_title: '更划算的选择',
            pay_tier_1_qty: '1 张',
            pay_tier_2_qty: '2 张',
            pay_tier_4_qty: '4 张',
            pay_tier_year_qty: '包年无限下载',
            pay_add_cart: '加入购物车',
            pay_added_cart: '已加入 ✓',
            cart_title: '下载列表',
            cart_select_all: '全选',
            cart_clear: '清空列表',
            cart_empty: '下载列表目前是空的',
            cart_total_label: '结算金额',
            cart_checkout: '结算',
            bazi_board_title: '八字排盘',
            pillar_year: '年柱',
            pillar_month: '月柱',
            pillar_day: '日柱',
            pillar_hour: '时柱',
        ...
        'en': {
            ...
            pay_per_image: '/ image',
            pay_per_2_images: '/ 2 images',
            pay_per_4_images: '/ 4 images',
            pay_per_year: '/ year',
            pay_notice: 'Virtual product — no refunds after purchase',
            pay_notice_year: 'The annual plan activates immediately after purchase and unlocks all paid features site-wide',
            pay_confirm: 'Confirm Payment',
            pay_tier_title: 'Better value',
            pay_tier_1_qty: '1 image',
            pay_tier_2_qty: '2 images',
            pay_tier_4_qty: '4 images',
            pay_tier_year_qty: 'Unlimited annual plan',
            pay_add_cart: 'Add to Cart',
            pay_added_cart: 'Added ✓',
            cart_title: 'Download List',
            cart_select_all: 'Select All',
            cart_clear: 'Clear List',
            cart_empty: 'Your download list is empty',
            cart_total_label: 'Total',
            cart_checkout: 'Checkout',
            bazi_board_title: 'BaZi Chart',
            ...
            period_year: 'Year',
            period_month: 'Month',
            btn_add_bazi: '+ Add Profile',
            btn_switch_bazi: 'Switch Profile',
            ...
            form_dst_label: 'Daylight Saving Time (DST)',
